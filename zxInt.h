...
struct zxDLL zxUInt : zxInt
{
	...
	unsigned int long long getIntLL( void );
};
struct zxDLL zxSInt : zxInt
{
	zxSInt( void );
	zxSInt( sill value );
	zxSInt( zxInt& value );
...
zxInt parseInt( zxText source, ui08 base = 10u );
