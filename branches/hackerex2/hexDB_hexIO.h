...
void xsDLL GetTxt( Text& to, void* from, ui08 bytes = 1u, ui08 fType = HEX_TYPE_HEX );
bool xsDLL GetHexFromUI( void* to, Text  from, ui08 tSize = 1u );
//void xsDLL GetTxtFromUI( Text& to, void* from, ui08 tSize = 1u );
bool xsDLL GetHexFromSI( void* to, Text  from, ui08 tSize = 1u );
bool xsDLL GetHexFromSF_IEEE754( void* to, Text  from, ui08 tSize = 1u );
void xsDLL GetTxtFromSF_IEEE754( Text& to, void* from, ui08 fSize = 1u );
