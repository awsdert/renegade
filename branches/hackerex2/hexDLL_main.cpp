...
#endif
zxDLL_EXP bool LibGetX( size_t address, void* value, ui32 bytes )
{
	ui08* v = ( ui08* )value;
...
zxDLL_EXP bool LibSetX( size_t address, void* value, ui32 bytes )
{
	ui08* v = ( ui08* )value;
	volatile ui08 *a = (ui08*)address;
	try
...
zxDLL_EXP bool LibGetPtr( size_t address, size_t* ptr )
{
	/*volatile ui08 *a = ( ui08* )address;
	try { ptr = &a; }
...
zxDLL_EXP bool LibGetPtrArray( ui16 loop, size_t* address_array, size_t** ptr_array )
{
	/*volatile ui08 *a;
	try
	{
