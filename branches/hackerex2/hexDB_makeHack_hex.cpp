...
// TODO(awsdert) Implement MakeHack_Hex_1()
	...
	code.cdeType	= (( 0xF0000000 & pt1 ) >> 28u );
	dataSize		= (( 0x0F000000 & pt1 ) >> 24u );
	code.cdeRam		= (( 0x00F00000 & pt1 ) >> 20u );
	code.cdeDepth	= (( 0x000F0000 & pt1 ) >> 16u );
	code.cdeInfo	= (( 0x0000FF00 & pt1 ) >>  8u );
	code.cdeLoop	=  ( 0x000000FF & pt1 );
	code.cdeAddr[ 1u ] = pt2;
	L_MH_HEX_GETPARTS( block, tknz, text, line, part1, part2, hex, pt1, pt2, l );
	bool addrBig = false;
	bool dataBig = false;
	bool isCopy = ( code.cdeType == HEX_CT_COPY );
	bool isTest = ( code.cdeType == HEX_CT_TEST );
	...
	{
		ui16 i = 0u, iCount = code.cdeInfo, iAdd;
