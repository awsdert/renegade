...
#define hexLib_gui_h
/* *
class zxDLL M_EGRID : public wxEvtHandler
{
private:
	void m_connect( void );
...
class zxDLL M_OGRID : public wxEvtHandler
{
private:
...
class zxDLL M_HTREE : public wxEvtHandler
{
public:
	wxTreeCtrl
		*htree, *ctree;
...
/*
class zxDLL hexDB : public wxEvtHandler
{
	hexGui* m_gui;
	Text	m_getDir( void );
