...
HexGUI::HexGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	HexMain_B = new wxButton( HexGUI_TB, HexMain_B_ID, _("&Main"), wxDefaultPosition, wxSize( -1,-1 ), wxBU_EXACTFIT );
	HexGUI_TB->AddControl( HexMain_B );
	HexList_B = new wxButton( HexGUI_TB, HexList_B_ID, _("&List"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	HexGUI_TB->AddControl( HexList_B );
	HexSave_B = new wxButton( HexGUI_TB, HexSave_B_ID, _("&Save"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	HexGUI_TB->AddControl( HexSave_B );
	HexGUI_TB->AddSeparator(); 
	
	HexNew_B = new wxButton( HexGUI_TB, HexNew_B_ID, _("&New"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	HexGUI_TB->AddControl( HexNew_B );
	HexDel_B = new wxButton( HexGUI_TB, HexDel_B_ID, _("&Delete"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	HexGUI_TB->AddControl( HexDel_B );
	HexSet_B = new wxButton( HexGUI_TB, HexSet_B_ID, _("&Comit"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	HexGUI_TB->AddControl( HexSet_B );
	HexGet_B = new wxButton( HexGUI_TB, HexGet_B_ID, _("&Restore"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	HexGUI_TB->AddControl( HexGet_B );
	HexGUI_TB->AddSeparator(); 
	
	HexFont_S = new wxStaticText( HexGUI_TB, wxID_ANY, _("Text Size"), wxDefaultPosition, wxDefaultSize, 0 );
	HexFont_S->Wrap( -1 );
	HexGUI_TB->AddControl( HexFont_S );
	HexFont_SPC = new wxSpinCtrl( HexGUI_TB, HexFont_SPC_ID, wxT("8"), wxDefaultPosition, wxSize( 50,-1 ), wxSP_ARROW_KEYS, 8, 16, 8 );
	...
	HexMain_B->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( HexGUI::HexGUI_TB_OnToolExec ), NULL, this );
	HexList_B->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( HexGUI::HexGUI_TB_OnToolExec ), NULL, this );
...
HexGUI::~HexGUI()
{
	...
	HexMain_B->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( HexGUI::HexGUI_TB_OnToolExec ), NULL, this );
	HexList_B->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( HexGUI::HexGUI_TB_OnToolExec ), NULL, this );
