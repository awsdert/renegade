...
zxInt parseInt( Text src, ui08 base )
{
	Text cmp = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	zxUInt des = 0u;
	if ( src.empty() )
		return des;
...
Text zxInt::toString( ui08 base )
{
	Text des, des2, cmp = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
